...
public class DBaseHelper extends SQLiteOpenHelper {
    ...
    /*五欄位*/
    private static final String CREATE_Punch = "create table if not exists Punch(id_punch integer primary key autoincrement, Date text, Time text, work text, ID text)";
